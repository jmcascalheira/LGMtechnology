...
```{r platformmaintenancetab, echo = FALSE}
...
knitr::kable(var_description_platform_maintenance, caption = "First two components of the MCA for the Platform Maintenance domain.")
...
```{r ANOVAplatformmaintenance, echo=FALSE, fig.cap = "Platform Maintenance multi-comparison bootstrap ANOVA. Error bars represent 95% confidence interval from the mean. Contexts sharing the same set of letters do not present statistically significan difference."}
...
The analysis of core exploitation using blanks aimed to characterize the way cores were rotated by knappers to create different dorsal surface convexity patterns during the sequences of reduction. A combination of dorsal cortex frequency, dorsal pattern, and number of scars in the dorsal surface was used in the MCA. Results are presented in Figure \@ref(fig:MCAcoreexploitation) and Table \@ref(tab:coreexploitationtab).
...
kable(var_description_core_exploitation, caption = "First two components of the MCA for the Core Exploitation domain.")

```

\n

```{r ANOVAcoreexploitation, echo=FALSE, fig.cap = "Core Exploitation multi-comparison bootstrap ANOVA. Error bars represent 95% confidence interval from the mean. Contexts sharing the same set of letters do not present statistically significan difference."}
...
kable(var_description_core_exploitation, caption = "First two components of the MCA for the Dorsal Surface Convexity domain.")

```



```{r ANOVAconvexity, echo=FALSE, fig.cap = "Dorsal Convexity multi-comparison bootstrap ANOVA. Error bars represent 95% confidence interval from the mean. Contexts sharing the same set of letters do not present statistically significan difference."}
...
kable(var_description_elongated, caption = "First two components of the MCA for the Elongated Products domain.")

```

\n

```{r ANOVAelongated, echo=FALSE, fig.cap = "Elongated Products multi-comparison bootstrap ANOVA. Error bars represent 95% confidence interval from the mean. Contexts sharing the same set of letters do not present statistically significan difference."}
...
```{r coremorphologytab, echo = FALSE}
...
kable(var_description_core_morphology, caption = "First two components of the MCA for the Core Morphology domain.")

```


```{r ANOVAcoremorphology, echo=FALSE, fig.cap = "Core Morphology multi-comparison bootstrap ANOVA. Error bars represent 95% confidence interval from the mean. Contexts sharing the same set of letters do not present statistically significan difference."}
...
kable(var_description_core_use, caption = "First two components of the MCA for the Core Use domain.")

```


```{r ANOVAcoreuse, echo=FALSE, fig.cap = "Core Use multi-comparison bootstrap ANOVA. Error bars represent 95% confidence interval from the mean. Contexts sharing the same set of letters do not present statistically significan difference."}
